...
In progress (P3): richer semantic selection (largest/smallest/extreme/adjacency done, all
live-verified) and sketch ergonomics (slots, center-point arcs, fillets, construction geometry
